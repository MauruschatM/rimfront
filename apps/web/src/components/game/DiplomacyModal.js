...
export function DiplomacyModal({ gameId, isOpen, onClose, targetPlayerId, myPlayerId, }) {
    ...
    const relationship = alliances.find((a) => (a.player1Id === myPlayerId && a.player2Id === targetPlayerId) ||
        (a.player1Id === targetPlayerId && a.player2Id === myPlayerId));
    // Check if teammate (Fixed Alliance)
    const isTeammate = myPlayer.teamId &&
        targetPlayer.teamId &&
    ...
    return (<Dialog onOpenChange={(open) => !open && onClose()} open={isOpen}>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-col gap-2">
                {isTeammate ? (<div className="text-center">
                  ...
                  </div>) : subMode !== "ffa" ? (<div className="text-center">
                    <p className="mb-4 text-muted-foreground">
                      Diplomacy disabled in Team modes
                    </p>
                  </div>) : status === "none" ? (<Button onClick={handleRequest}>Request Alliance</Button>) : status === "pending" && isSender ? (<Button onClick={handleReject} variant="outline">
                    Cancel Request
                  </Button>) : }
                {status === "pending" && !isSender && (<div className="flex gap-2">
                ...
                {status === "allied" && (<div className="flex flex-col gap-2">
                ...
                .padStart(2, "0")}
                    ...
                    {timeLeft <= 30_000 && (<Button className="w-full" onClick={handleRenew} variant="default">
                        Renew Alliance
                      </Button>)}
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                          ...
                          <AlertDialogAction className="bg-destructive text-destructive-foreground hover:bg-destructive/90" onClick={handleBreak}>
                            Yes, Break Alliance
                          </AlertDialogAction>
                        </AlertDialogFooter>
                      </AlertDialogContent>
